...
$t->is((string) $new, '<ul id="root-2-menu"><li id="test-menu-child-1" class="first">Child 1<ul id="child-1-menu"><li id="test-menu-child-2" class="first last">Child 2</li></ul></li><li id="test-menu-root-3" class="last">Root 3<ul id="root-3-menu"><li id="test-menu-child-1" class="first last">Child 1</li></ul></li></ul>');

$menu['Test']['With Route']->setRoute('http://www.google.com');
$t->is((string) $menu['Test'], '<ul id="test-menu"><li id="test-menu-with-route" class="first last"><a href="http://www.google.com">With Route</a></li></ul>');
$menu['Test']['With Route']->setOption('target', '_BLANK');
$t->is((string) $menu['Test'], '<ul id="test-menu"><li id="test-menu-with-route" class="first last"><a target="_BLANK" href="http://www.google.com">With Route</a></li></ul>');
...
$t->is($first->isFirst(), true);
$t->is($last->isLast(), true);
$t->is($middle->isFirst(), false);
$t->is($middle->isLast(), false);
$t->is($first->getNum(), 1);
