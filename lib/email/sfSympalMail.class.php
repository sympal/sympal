...
class sfSympalMail
{
  ...
  {
    sfProjectConfiguration::getActive()->getEventDispatcher()->notify(new sfEvent($this, 'sympal.email.pre_send', array('mailer' => $this->_mailer, 'message' => $this->_message, 'email_address' => $emailAddress)));
    ...
    sfProjectConfiguration::getActive()->getEventDispatcher()->notify(new sfEvent($this, 'sympal.email.post_send', array('mailer' => $this->_mailer, 'message' => $this->_message, 'email_address' => $emailAddress)));
  }
