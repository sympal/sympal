<div id="sf_admin_container">
  ...
  <div id="sf_admin_configuration">
    <div class="sf_admin_form">
      <?php echo $form->renderFormTag(url_for('sympal_assets_edit_asset')) ?>
        ...
        <?php echo button_to('Delete Asset', '@sympal_assets_delete_asset?file='.urlencode($asset->getRelativePath())) ?>
      </form>
    </div>
  </div>
</div>