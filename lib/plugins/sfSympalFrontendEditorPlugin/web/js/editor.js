$(function()
{
  ...
  var pos = $('.toggle_editor_menu').offset();  
  var width = $('.toggle_editor_menu').width();
  ...
  $('.toggle_editor_menu').click(function() {
    $('#sympal_editor').slideToggle('fast');
  });
  ...
  var pos = $('.toggle_sympal_assets').offset();  
  var width = $('.toggle_sympal_assets').width();
  ...
  $('.toggle_sympal_assets').click(function() {
    $('#sympal_assets').load($(this).attr('rel'));
    $('#sympal_assets').slideToggle('fast');
  });

  var pos = $('.toggle_sympal_links').offset();  
  var width = $('.toggle_sympal_links').width();
  ...
  $('.toggle_sympal_links').click(function() {
    $('#sympal_links').load($(this).attr('rel'));
    $('#sympal_links').slideToggle('fast');
  });
});
