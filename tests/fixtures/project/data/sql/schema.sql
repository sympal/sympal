...
CREATE TABLE blog (id BIGINT AUTO_INCREMENT, name VARCHAR(255), body LONGTEXT, entity_id INT, INDEX entity_id_idx (entity_id), PRIMARY KEY(id)) ENGINE = INNODB;
...
ALTER TABLE blog ADD FOREIGN KEY (entity_id) REFERENCES entity(id) ON DELETE CASCADE;
