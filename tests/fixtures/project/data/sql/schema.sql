...
CREATE TABLE comment (id BIGINT AUTO_INCREMENT, status VARCHAR(255) DEFAULT 'Pending' NOT NULL, user_id BIGINT, name VARCHAR(255), subject VARCHAR(255), body LONGTEXT NOT NULL, created_at DATETIME, updated_at DATETIME, INDEX user_id_idx (user_id), PRIMARY KEY(id)) ENGINE = INNODB;
...
CREATE TABLE content_slot_type (id BIGINT AUTO_INCREMENT, name VARCHAR(255) NOT NULL UNIQUE, PRIMARY KEY(id)) ENGINE = INNODB;
...
CREATE TABLE content_type (id BIGINT AUTO_INCREMENT, name VARCHAR(255) NOT NULL UNIQUE, description LONGTEXT, label VARCHAR(255) NOT NULL, plugin_name VARCHAR(255), list_path VARCHAR(255), view_path VARCHAR(255), layout VARCHAR(255), slug VARCHAR(255), INDEX name_idx (name), UNIQUE INDEX sluggable_idx (slug), PRIMARY KEY(id)) ENGINE = INNODB;
CREATE TABLE route (id BIGINT AUTO_INCREMENT, name VARCHAR(255) NOT NULL UNIQUE, url VARCHAR(255) NOT NULL, type VARCHAR(255), content_id BIGINT, content_type_id BIGINT, slug VARCHAR(255), INDEX type_idx (type), UNIQUE INDEX sluggable_idx (slug), INDEX content_id_idx (content_id), INDEX content_type_id_idx (content_type_id), PRIMARY KEY(id)) ENGINE = INNODB;
