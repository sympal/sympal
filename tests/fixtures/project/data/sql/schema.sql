...
CREATE TABLE language (id INTEGER PRIMARY KEY AUTOINCREMENT, code VARCHAR(255) NOT NULL);
CREATE TABLE translation_translation (id INTEGER, value LONGTEXT, lang CHAR(2), PRIMARY KEY(id, lang));
CREATE TABLE translation (id INTEGER PRIMARY KEY AUTOINCREMENT, name VARCHAR(255) NOT NULL UNIQUE);
