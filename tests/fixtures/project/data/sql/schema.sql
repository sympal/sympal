...
CREATE TABLE menu_item (id INTEGER PRIMARY KEY AUTOINCREMENT, site_id INTEGER NOT NULL, content_type_id INTEGER, content_id INTEGER, name VARCHAR(255) NOT NULL, custom_path VARCHAR(255), is_content_type_list INTEGER DEFAULT '0', requires_auth INTEGER, requires_no_auth INTEGER, is_primary INTEGER, is_published INTEGER, date_published DATETIME, slug VARCHAR(255), root_id INTEGER, lft INTEGER, rgt INTEGER, level INTEGER);
...
CREATE TABLE content_slot (id INTEGER PRIMARY KEY AUTOINCREMENT, content_id INTEGER NOT NULL, content_slot_type_id INTEGER NOT NULL, is_column INTEGER DEFAULT '0', name VARCHAR(255) NOT NULL);
...
CREATE TABLE content_type (id INTEGER PRIMARY KEY AUTOINCREMENT, name VARCHAR(255) NOT NULL, label VARCHAR(255) NOT NULL, list_path VARCHAR(255), view_path VARCHAR(255), layout VARCHAR(255), slug VARCHAR(255));
