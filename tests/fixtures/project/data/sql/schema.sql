...
CREATE TABLE content_type_translation (id INT, label VARCHAR(255) NOT NULL, lang CHAR(2), PRIMARY KEY(id, lang)) ENGINE = INNODB;
CREATE TABLE content_type (id INT AUTO_INCREMENT, name VARCHAR(255) NOT NULL, list_path VARCHAR(255), view_path VARCHAR(255), layout VARCHAR(255), slug VARCHAR(255), UNIQUE INDEX sluggable_idx (slug), PRIMARY KEY(id)) ENGINE = INNODB;
...
ALTER TABLE content_type_translation ADD FOREIGN KEY (id) REFERENCES content_type(id) ON UPDATE CASCADE ON DELETE CASCADE;
