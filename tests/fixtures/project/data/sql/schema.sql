...
CREATE TABLE content_slot_type (id BIGINT AUTO_INCREMENT, name VARCHAR(255) NOT NULL UNIQUE, is_internal TINYINT(1) DEFAULT '0', site_id BIGINT NOT NULL, INDEX site_id_idx (site_id), PRIMARY KEY(id)) ENGINE = INNODB;
...
ALTER TABLE menu_item ADD FOREIGN KEY (content_id) REFERENCES content(id) ON DELETE CASCADE;
