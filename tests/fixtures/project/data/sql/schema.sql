...
CREATE TABLE event (id BIGINT AUTO_INCREMENT, title VARCHAR(255), body LONGTEXT, content_id INT, INDEX content_id_idx (content_id), PRIMARY KEY(id)) ENGINE = INNODB;
...
CREATE TABLE content_slot (id INT AUTO_INCREMENT, content_id INT NOT NULL, content_slot_type_id INT NOT NULL, is_column TINYINT(1) DEFAULT '0', render_function VARCHAR(255), name VARCHAR(255) NOT NULL, INDEX content_id_idx (content_id), INDEX content_slot_type_id_idx (content_slot_type_id), PRIMARY KEY(id)) ENGINE = INNODB;
