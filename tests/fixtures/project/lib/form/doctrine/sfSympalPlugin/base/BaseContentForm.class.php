...
class BaseContentForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'last_updated_by'     => new sfValidatorDoctrineChoice(array('model' => 'User', 'required' => false)),
      'created_by'          => new sfValidatorDoctrineChoice(array('model' => 'User', 'required' => false)),
      'locked_by'           => new sfValidatorDoctrineChoice(array('model' => 'User', 'required' => false)),
